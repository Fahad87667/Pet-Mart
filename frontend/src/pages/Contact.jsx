  ...
  const handleChange = (e) => {
    ...
    if (name === "phone") {
      ...
      if (!phoneRegex.test(value)) {
        setPhoneError(
          "Please enter a valid 10-digit number starting with 7, 8 or 9 ."
        );
      } else {
        setPhoneError("");
      }
      ...
      <Container className="py-5">
        ...
        >
          ...
          <p className="lead" style={{ color: "#6b7280" }}>
            Have questions about our pet products or services? We're here to
            help!
          </p>
        </div>
              ...
              <Card.Body>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mb-0" style={{ color: "#a855f7" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mb-1" style={{ color: "#a855f7" }}>
                      (123) 456-7890
                    </p>
                    <p className="mb-0" style={{ color: "#a855f7" }}>
                      (987) 654-3210 (Emergency)
                    </p>
                  </div>
                </div>
              ...
              <Card.Body>
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3" controlId="phone">
                    ...
                    <Form.Text>Must be 10 digits number</Form.Text>
                  </Form.Group>
                  ...
                  <Form.Group className="mb-4" controlId="message">
                    ...
                    <Form.Control.Feedback type="invalid">
                      {messageError ||
                        "Message must be between 20-500 characters."}
                    </Form.Control.Feedback>
                    <Form.Text>
                      Message must be between 20-500 characters
                    </Form.Text>
